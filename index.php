    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active text-white" aria-current="page" href="index.php">Danh sách nhân sự</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="module/activities/activity_management.php">Quản lý hoạt động</a>
                    </li>
                </ul>
            </div>
        </nav>
